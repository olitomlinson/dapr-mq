"""DaprMQ Python producer example — control-plane HTTP server.
...
SCENARIO_DESCRIPTIONS = {
    "basic": "Enqueues 3 plain items.",
    "ack-deadletter": "Enqueues 3 items tagged ack/deadletter/expire.",
    "priority": "Enqueues normal-priority items, then fast-lane items.",
    "sessions": "Enqueues items across two sessions.",
    "idempotency": "Enqueues an item, a duplicate reusing its idempotency key, then a distinct item.",
}
