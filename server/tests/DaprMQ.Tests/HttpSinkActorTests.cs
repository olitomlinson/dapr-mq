...
public class HttpSinkActorTests
{
    ...
    public async Task DynamicPolling_EmptyQueue_DoublesInterval()
    {
        ...
        // Mock DequeueLocked to return empty queue
        mockQueueInvoker.Setup(m => m.InvokeMethodAsync<DequeueLockedRequest, DequeueLockedResponse>(
                It.IsAny<ActorId>(),
                "DequeueLocked",
    ...
    public async Task DynamicPolling_ItemsFound_ResetsTo1Second()
    {
        ...
        // Mock DequeueLocked to return items
        mockQueueInvoker.Setup(m => m.InvokeMethodAsync<DequeueLockedRequest, DequeueLockedResponse>(
                It.IsAny<ActorId>(),
                "DequeueLocked",
                It.IsAny<DequeueLockedRequest>()))
    ...
    public async Task DynamicPolling_MaxConcurrencyReached_IncreasesButCapsAt4Seconds()
    {
        ...
        // Mock DequeueLocked to return MaxConcurrencyReached
        mockQueueInvoker.Setup(m => m.InvokeMethodAsync<DequeueLockedRequest, DequeueLockedResponse>(
                It.IsAny<ActorId>(),
                "DequeueLocked",
                It.IsAny<DequeueLockedRequest>()))
