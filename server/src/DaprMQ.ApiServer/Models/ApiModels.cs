...
// Request models
public record ApiEnqueueRequest(
    List<ApiEnqueueItem> Items
);

public record ApiEnqueueItem(
    JsonElement Item,
    int Priority = 1,
...
// Response models
public record ApiEnqueueResponse(
    bool Success,
    string Message,
    int ItemsEnqueued,
...
public record ApiDequeueResponse(
    List<ApiDequeueItem> Items
);

public record ApiDequeueItem(
    object Item,
    int Priority
);

public record ApiDequeueLockedResponse(
    List<ApiDequeueLockedItem> Items,
    bool Locked,
    string? Message = null
);

public record ApiDequeueLockedItem(
    object Item,
    int Priority,
    string LockId,
...
public record ApiAcceptSessionRequest(
    string? SessionId = null,
    int LeaseSeconds = 30
);

public record ApiAcceptSessionResponse(
    string SessionId,
    string LeaseId,
    double LeaseExpiresAt
);

public record ApiRenewSessionLeaseRequest(
    string LeaseId,
    int AdditionalSeconds = 30
);

public record ApiRenewSessionLeaseResponse(
    double NewExpiresAt
);

public record ApiReleaseSessionRequest(
    string LeaseId
);

public record ApiReleaseSessionResponse(
    bool Success
);
