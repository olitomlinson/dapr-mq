...
/// <summary>
/// Implementation of ITopicActorInvoker that uses Dapr's ActorProxy.
/// This wrapper enables unit testing by providing a mockable interface.
/// </summary>
public class TopicActorInvoker : ITopicActorInvoker
{
    private readonly IActorProxyFactory _actorProxyFactory;
    private readonly string _actorType;

    public TopicActorInvoker(IActorProxyFactory actorProxyFactory, string actorType)
    {
